        ...
        <div className='mt-12 xl:mt-20  xl:pt-8'>
            <div className="container mx-auto px-3 2xl:px-0 max-w-[1364px]">
                <div className="flex flex-wrap-reverse lg:flex-wrap items-center justify-center lg:justify-between relative">
                    ...
                    <div className='w-full lg:w-[47%] flex items-center justify-center mt-5'>
                    ...
                    <div className='w-full md:w-[80%] lg:w-[44%] flex flex-col items-center justify-center text-center lg:text-start '>
                        <h2 className='font-parabolica-bold text-[21px] 2xl:max-w-[580px] max-w-[310px] sm:max-w-full sm:text-4xl  xl:text-[50px] text-primary !leading-[115%]'>Connecting EV Charging Station Owners and Repair Contractors</h2>
                        <p className='font-grotesk font-normal text-base md:text-xl lg:text-2xl text-secondary !leading-[115%] mt-1.5 lg::mt-6'>MAIVO Streamlines the connection between EV Charging Station owners and expert repair technician contractors through a specialized network that facilitates maintenance contracting</p>
                    </div>
                </div>
            </div>
            <div className="container max-w-[1510px] px-3 lg:px-6 mx-auto py-12 lg:py-[85px]">
                <div className="flex flex-wrap justify-between relative">
                    ...
                    <div className='w-full  lg:w-[24%] xl:w-[20%] relative top-1.5 '>
                        <div className='shadow-[-10px_10px_0px_0px_#45CDFF] bg-white pl-3 pr-2 pt-3 pb-4  md:pl-[28px]  md:pr-6  md:pt-[38px]  md:pb-11  border-[#45CDFF] border-2 max-w-[200px] md:max-w-[288px] xl:absolute -top-3'>
