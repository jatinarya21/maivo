        ...
        <div className='mt-12 xl:mt-20  xl:pt-8'>
            ...
            <div className="container max-w-[1510px] px-3 mx-auto py-12 lg:py-[85px]">
                <div className="flex flex-wrap justify-between relative">
                    ...
                    <div className='w-full  lg:w-[20%] relative top-1.5 '>
                        <div className='shadow-[-10px_10px_0px_0px_#45CDFF] bg-white pl-3 pr-2 pt-3 pb-4  md:pl-[29px]  md:pr-6  md:pt-[38px]  md:pb-11  border-[#45CDFF] border-2 max-w-[200px] md:max-w-[288px]'>
                            <p className='font-parabolica-bold font-bold text-secondary text-sm md:text-lg'>Contractors go through a proprietary vetting process and join MAIVO's network of qualified contracting parties</p>
                        </div>
                    </div>
                    <div className='w-full lg:w-[51%] flex justify-center'>
                        <img width={728} height={439} className='w-[728px]' src={ConnectingEvChargerRecentActivty} alt="" />
                    </div>
                    <div className='w-full relative -top-4 lg:w-[24%] flex items-end justify-end'>
                        <div className='shadow-[-10px_10px_0px_0px_#45CDFF] bg-white pl-3 pr-2 pt-3 pb-2 md:pl-[26px]  md:pr-6  md:pt-[14px]  md:pb-3  border-[#45CDFF] border-2 max-w-[200px] md:max-w-[288px]'>
                            <p className='font-parabolica-bold font-bold text-secondary text-sm md:text-lg'>EV Charging Station Owners and Operators add their infrastructure to MAIVO and request repair and maintenance services from qualified contractors.</p>
                        </div>
                    </div>
                </div>
            </div>
