    ...
    return (
        <div className='bg-light-blue py-12 lg:py-20 xl:py-[100px]'>
            <div className='container mx-auto px-3 xl:px-0 max-w-[1322px]'>
                <h2 className='text-center font-parabolica-bold font-bold text-[50px] '>Why It Matters</h2>
                <div className='flex flex-wrap justify-between pt-9 md:pt-[59px] gap-y-10 lg:gap-y-20'>
                    {
